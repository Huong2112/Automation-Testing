...
public class ScrollTapUtils {
    ...
    public  void swipeMobileToCategory(AndroidDriver driver) {
        Dimension screenSize = driver.manage().window().getSize();
        int starty = (int) (screenSize.height * 0.7);
    ...
    public  void swipeSlight(AndroidDriver driver) {
        Dimension screenSize = driver.manage().window().getSize();
    ...
    public  void lightScrollInLeftMenu(AndroidDriver driver) {
        Dimension screenSize = driver.manage().window().getSize();
